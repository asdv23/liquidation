...
func (_ERC20 *ERC20Transactor) Mint(opts *bind.TransactOpts, value *big.Int) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "mint", value)
}

// Mint is a paid mutator transaction binding the contract method 0xa0712d68.
//
// Solidity: function mint(uint256 value) returns(bool)
func (_ERC20 *ERC20Session) Mint(value *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.Mint(&_ERC20.TransactOpts, value)
}

// Mint is a paid mutator transaction binding the contract method 0xa0712d68.
//
// Solidity: function mint(uint256 value) returns(bool)
func (_ERC20 *ERC20TransactorSession) Mint(value *big.Int) (*types.Transaction, error) {
	return _ERC20.Contract.Mint(&_ERC20.TransactOpts, value)
}
